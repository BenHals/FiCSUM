...
class Sampler():
    def __init__(self, num_features, random_state = None, features = ['distribution', 'autocorrelation', 'frequency']):
...
class RandomTreeGeneratorSample(Stream):
    ...
    def __init__(self, tree_random_state=None, sample_random_state=None, sampler_random_state=None,
                 sampler_features = ['distribution', 'autocorrelation', 'frequency'], n_classes=2, n_cat_features=0,
                 n_num_features=5, n_categories_per_cat_feature=5, max_tree_depth=6, min_leaf_depth=4,
                 fraction_leaves_per_level=0.15):
        super().__init__()
